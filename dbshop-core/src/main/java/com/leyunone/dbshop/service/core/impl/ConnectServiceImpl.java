...
public class ConnectServiceImpl implements ConnectService {
    ...
    public static DatabaseMetaData toTest() throws SQLException, ClassNotFoundException {
        ConnectServiceImpl connectService = new ConnectServiceImpl();
        String url = "jdbc:mysql://127.0.0.1:3306/smarthome?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&allowMultiQueries=true";
