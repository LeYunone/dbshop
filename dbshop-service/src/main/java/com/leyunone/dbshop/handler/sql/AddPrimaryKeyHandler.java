 ...
 */
@SqlHandler(SqlModelEnum.ADD_PRIMARY_KEY)
public class AddPrimaryKeyHandler extends SqlProductionAbstractHandler{
    ...
    public String handler(JSONObject json) {
        ...
        return TextFillUtil.fillStr(SqlModelEnum.ADD_PRIMARY_KEY.getSqlModel(),columnInfo.getTableName(),columnInfo.getColumnName());
    }
